  ...
  return (
    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        <a href="#hero" className="block w-[12rem] xl:pr-8 ">
          ...
          >
            {navigation.map((item) => (
              ...
              text-n-1 transition-colors hover:text-color-1 ${
               ...
               ${
                 item.url === pathname.hash ? "z-2 lg:text-x-1 " : "text-n-1/50"
        ...
        <a
          href="#signup"
          className="hidden mr-8 text-n-1/50 transition-colors hover:text-n-1
          lg:block"
        >
          New account
        </a>
